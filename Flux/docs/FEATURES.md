...
Browser tools retains preferences and managers: workspaces, privacy, search providers, passwords and downloads. **Open PDF…** is under Downloads. JavaFX compatibility page controls are retained for the future cross-platform version and are hidden in the native macOS build.
